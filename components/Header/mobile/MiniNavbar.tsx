...
const MiniNavbar: FC<MiniNavbarProps> = ({ isOpen, handleClick }) => {
    ...
    return (
        ...
        >
            ...
            <div
                className=" flex justify-start gap-3 flex-col h-full mt-4 w-full">
                {navigation?.map((data) => {
                ...
                <Link target='_blank' rel="noreferer" href="mailto:nayangit000@gmail.com" className="mt-6 text-center" >
                    <HoverButton
                        label="Hire Me" />
                </Link>
            </div >
