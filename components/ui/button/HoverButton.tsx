...
const HoverButton: FC<HoverButtonProps> = ({
  ...
  return (
    <button
      className={cn(
        "cursor-pointer relative inline-flex items-center justify-center overflow-hidden  font-medium  rounded-[10px] group px-5 py-2 text-white bg-gray-600 lg:text-lg",
        className
      )}
      {...props}
    >
